...
支持实时预览、分屏编辑、图片嵌入、链接跳转（文件/网址分流）、AI 智能文件名生成。另有终端版 **[VIMD](https://github.com/Offblink/VIMD)**（VIM+MD，基于 Textual，已独立成仓）。
...
- 终端版已独立为 **[VIMD](https://github.com/Offblink/VIMD)**（Textual：三视图与预览滚动、格式快捷键包裹选区、系统文件对话框、查找替换弹窗；`io`/`links` 纯逻辑沿用本仓 v2）
